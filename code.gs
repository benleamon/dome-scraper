function scrapeDome() {
  // Replace the URL with the website you want to scrape data from
  //var url = 'https://www.kyoceradome-osaka.jp/events/';
  //var url = 'https://www.kyoceradome-osaka.jp/events/?yearId=2023&monthId=9';
